...
In the numerical results we see similar numbers to the master branches results. The white race with 67% in favor of capital punishment. The black race contains 47% in favor, and the other race with 61%. This mimics the numbers of the above chart, and can be seen as well in the master branch.
...
Using the Fisher test the numerical results give us insight into the differences between each comparison using the new data. The CHI test confirmed this information and provides a probability value of less than .000000000000000022 percent. This number is too small. 
